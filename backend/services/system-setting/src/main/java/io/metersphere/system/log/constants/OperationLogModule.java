...
public class OperationLogModule {
    ...
    // 场景管理
    public static final String API_TEST_SCENARIO_MANAGEMENT_SCENARIO = "API_TEST_SCENARIO_MANAGEMENT_SCENARIO";
    public static final String API_TEST_SCENARIO_MANAGEMENT_MODULE = "API_TEST_SCENARIO_MANAGEMENT_MODULE";
